...
def load(path=None):
    """See http://www.timeseriesclassification.com/description.php?Dataset=CatsDogs
    Parameters
    ----------
        path: str (optional)
    ...
    path = path / "extracted_CatsDogs"

    data_train = arff.loadarff(path / "CatsDogs_TRAIN.arff")
    data_test = arff.loadarff(path / "CatsDogs_TEST.arff")
