...
class StableDataset:
    ...
    def _iter_shards(self, *, shuffle: bool = False, seed: int | None = None):
        ...
        When *shuffle* is True, both the shard order and the row order within
        each shard are randomised.  This gives near-global randomness as long
        ...
        for shard_id in shard_order:
            ...
            if shuffle:
                ...
                row_order = range(shard_table.num_rows)
