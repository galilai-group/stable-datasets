...
class MNIST(BaseDatasetBuilder):
    ...
    SOURCE = DatasetSource(
        ...
        assets= {
            "train_images": DownloadInfo(url="https://storage.googleapis.com/cvdf-datasets/mnist/train-images-idx3-ubyte.gz"),

            "train_labels": DownloadInfo(url="https://storage.googleapis.com/cvdf-datasets/mnist/train-labels-idx1-ubyte.gz"),

            "test_images": DownloadInfo(url="https://storage.googleapis.com/cvdf-datasets/mnist/t10k-images-idx3-ubyte.gz"),

            "test_labels": DownloadInfo(url="https://storage.googleapis.com/cvdf-datasets/mnist/t10k-labels-idx1-ubyte.gz"),
